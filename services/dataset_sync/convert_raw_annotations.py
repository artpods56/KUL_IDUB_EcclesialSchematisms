...
def push_to_hf_repo(config, commit_message_metadata=""):
    ...
    try:
        ...
        # config_manager['OUT_JSONL'] is a Path object representing the relative path like 'labels/train.jsonl'
        ...
        logging.error("A git command failed during push_to_hf_repo. See logs above.")
