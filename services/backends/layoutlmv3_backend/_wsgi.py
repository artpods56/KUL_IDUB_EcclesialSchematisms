...
_DEFAULT_CONFIG_PATH = os.path.join(os.path.dirname(__file__), "config_manager.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Directory where ml_models are stored (relative to the project directory)",
    )
    ...
    if args.check:
        print('Check "' + LayoutLMv3Backend.__name__ + '" instance creation..')
        model = LayoutLMv3Backend(**kwargs)
    ...
    # for uWSGI use
    app = init_app(model_class=LayoutLMv3Backend)
