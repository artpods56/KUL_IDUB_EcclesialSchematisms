...
from notarius_core.operators.tables import Table
...
class IsolatedDuckDbArtifactTableExecutor:
    ...
    async def execute(
        ...
        with tempfile.TemporaryDirectory(prefix="notarius-artifact-sql-") as workdir:
            process = await asyncio.create_subprocess_exec(
                ...
                "utf8",
                "-m",
                "notarius_plugin_sql.artifact_query_worker",
