...
from grafy_core.runtime.resolvers import InlineModelResolver, Resolver

from grafy_plugin_ocr import mistral, tables, tesseract
...
from grafy_plugin_ocr.resolvers import (
