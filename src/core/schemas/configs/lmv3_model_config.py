...
class TrainingConfig(BaseModel):
    ...
    per_device_eval_batch_size: int = Field(default=1, description="Batch size per device for evaluation")
    ...
    run_name: str = Field(default="layoutlmv3-large-focal", description="Run name")
