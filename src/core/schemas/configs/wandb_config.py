...
class WandbConfig(BaseModel):
    ...
    project: str = Field(default="ai-osrodek", description="Weights & Biases project name")
    entity: str = Field(default="", description="Weights & Biases entity name")
    name: str = Field(default="experiment", description="Weights & Biases run name")
