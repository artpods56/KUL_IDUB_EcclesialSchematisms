      ...
      <main className="ns-workspace-directory__main">
        <header className="ns-workspace-directory__header">
          <div>
            ...
            <p>
              Choose a workspace or create a shared one. Personal workspaces are
        ...
        {!workspaces ? (
          <p className="ns-workspace-directory__loading">Loading workspaces…</p>
        ) : workspaces.length === 0 ? (
          <p className="ns-workspace-directory__loading">
            No workspaces are available to this session.
          </p>
        ) : (
