...
class TestLLMModel:
    ...
    def test_text_only_prediction_structured(self, llm_model, mock_openai_api, sample_structured_response):
    ...
    def test_image_only_prediction_structured(self, llm_model, mock_openai_api, sample_structured_response,
                                              sample_pil_image):
    ...
    def test_image_and_text_prediction_structured(self, llm_model, mock_openai_api, sample_structured_response,
                                                  sample_pil_image):
    ...
    def test_text_only_prediction_unstructured(self, llm_model, mock_openai_api, sample_structured_response,
                                               monkeypatch):
        ...
        monkeypatch.setitem(llm_model.interface.interface_config, "structured_output", False)
        response = llm_model.predict(
            text="This is a test text",
        )
    ...
    def test_image_only_prediction_unstructured(self, llm_model, mock_openai_api, sample_structured_response,
                                                sample_pil_image, monkeypatch):
    ...
    def test_malformed_json_response(self, llm_model, mock_openai_api, malformed_json_response):
    ...
    def test_extremely_long_text(self, llm_model, mock_openai_api, sample_structured_response):
    ...
    def test_special_characters_in_text(self, llm_model, mock_openai_api, sample_structured_response):
    ...
    def test_cache_disabled_behavior(self, llm_model_config, mock_openai_api, sample_structured_response):
        """Test behavior when cache is disabled"""
        llm_model = LLMModel(config=llm_model_config, enable_cache=False, test_connection=False)
    ...
    def test_with_hints_parameter(self, llm_model, mock_openai_api, sample_structured_response):
    ...
    def test_with_multiple_kwargs(self, llm_model, mock_openai_api, sample_structured_response):
    ...
    def test_image_and_text_prediction_unstructured(self, llm_model, mock_openai_api, sample_structured_response,
                                                    sample_pil_image, monkeypatch):
