"""Tests for GenerateSourceDataset use case."""
...
class TestGenerateSourceDataset:
    """Test suite for GenerateSourceDataset use case."""
    ...
    async def test_execute_processes_all_items(
        ...
        use_case = GenerateSourceDataset(dataset_processor=fake_processor)

        request = GenerateSourceDatasetRequest(dataset=sample_prediction_dataset)
